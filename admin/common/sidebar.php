 ...
 <div class="sidebar">
     ...
     <div class="sidebar-menu">
         <ul>
             <li class="<?php echo ($page_name==='index'?'active':''); ?>"><a href="<?php echo ADMIN_URL; ?>"><span class="las la-igloo"></span> <span>Dashboard</span></a>
             </li>
              <!-- active 
              <?php echo ($page_name==='edit'?'active':''); ?> <?php echo ($page_name==='post-new'?'active':''); ?> <?php echo ($page_name==='edit-tags'?'active':''); ?><?php echo ($page_name==='edit'&& $_GET['taxonomy']==='post_tag'?'active':''); ?>
            -->
