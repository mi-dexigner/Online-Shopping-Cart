...
$page_link = 'https://'.$_SERVER['HTTP_HOST'].'/'.htmlspecialchars(basename($_SERVER["PHP_SELF"], '.php'), ENT_QUOTES, "utf-8");
$page_name = htmlspecialchars(basename($_SERVER["PHP_SELF"], '.php'), ENT_QUOTES, "utf-8");
$uri = rtrim( dirname($_SERVER["SCRIPT_NAME"]), '/' );
$uri = '/' . trim( str_replace( $uri, '', $_SERVER['REQUEST_URI'] ), '/' );
$uri = urldecode( $uri );
$someNon404Condition = pathinfo($uri, PATHINFO_EXTENSION);
if($someNon404Condition ==="php"){
